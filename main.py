...
def main():
    ...
    label = tk.Label(root, text="Sign language conversion", font=('Comic Sans MS', 60, "bold"),fg="#F5EAEA", bg="#363636")
    ...
    sign_to_speech_button = tk.Button(button_frame, text="Sign language to speech", command=sign_to_speech,
    ...
    speech_to_sign_button = tk.Button(button_frame, text="Speech to sign language", command=speech_to_sign,
                                      font=("Calisto MT", 25, "bold"), fg="#F5EAEA", bg="#20262E", width=30, height=3)
